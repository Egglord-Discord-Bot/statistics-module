...
module.exports = {
	...
	getGuildHistory: async function(bot) {

		const members = [];
		for (const guild of bot.guilds.cache.values()) {
			const guildMember = guild.members.me.fetch();
			members.push({ id: guildMember.id, joinedAt: guildMember.joinedAt });
		}
		let history = members.sort((a, b) => a.joinedAt - b.joinedAt);
